...
from back.QWERTYHierarchic import QWERTYHierarchic
...
class Navbar(QWidget):
    ...
    def KeyboardTypeBtnOnClick(self):
        ...
        self.QWERTYHierarchicKboardButton = self.ButtonInit(lambda: self.KeyboardTypeOnChange(QWERTYHierarchic(), QwertyKeyboard(), "QWERTY Hierarchic"), "QWERTY Hierarchic")
        self.QWERTYHierarchicKboardButton.setObjectName("MultiBtn")
        ...
        if self.headHand == "Hand":
            if self.keyboardDisplayMethod == "Line":
                ...
                self.gridLayout.addWidget(self.QWERTYHierarchicKboardButton, 7, 1, 1, 1)
                ...
                self.gridLayout.addWidget(self.QWERTYHierarchicKboardButton, 9, 1, 1, 1)
    ...
    def KeyboardTypeOnChange(self, type, method, title):
        ...
        self.parent.cameraView.Launcher.keyboard.emit(method)
        self.ButtonReplace([self.headSwipeKboardButton, self.headSwipeKboardStaticButton, self.headEightpenKboardButton, self.swipeKboardButton, self.swipeKboardStaticButton, self.eightpenKboardButton, self.QWERTYHoverKboardButton, self.QWERTYKboardButton, self.QWERTYHierarchicKboardButton, self.QWERTYTileKboardButton], self.keyboardTypeButton, 7)
